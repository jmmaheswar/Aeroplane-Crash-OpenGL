...
void display(void)
{
	...
	char str[] = "COMPUTER GRAPHICS LAB";
	glRasterPos2f(200, 450);
	for (i = 0;i < strlen(str);i++) {
		glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, str[i]);
	}
	glColor3f(0.302f, 1.000f, 0.302f);
	char str1[] = "MINI PROJECT";
	glRasterPos2f(200, 420);
	for (i = 0;i < strlen(str1);i++) {
		glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, str1[i]);
	}
	glColor3f(0.302f, 0.000f, 0.302f);
	char str11[] = " MRS CHAITRA VS ";
	glRasterPos2f(400, 180);
	for (i = 0;i < strlen(str11);i++) {
		glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18, str11[i]);
	}
	glColor3f(0.302f, 0.000f, 0.302f);
	char str12[] = " Asst. Professor ";
	glRasterPos2f(400, 150); //calculate points by referring previous text positions
	for (i = 0;i < strlen(str12);i++) {
		glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18, str12[i]);
	}
	glColor3f(0.302f, 0.000f, 0.302f);
	char str13[] = " DEPT OF CS ";
	glRasterPos2f(400, 125); //calculate points by referring previous text positions
...
void firstwindow(unsigned char firstwindow, int x, int y)
{
	...
	if (firstwindow == 'E' || firstwindow == 'e')
	{
		...
		id2 = glutCreateWindow("Aeroplane Crash Simulation");
